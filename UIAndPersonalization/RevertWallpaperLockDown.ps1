# RevertWallpaperLockdown.ps1
# Restores user ability to change wallpaper and removes enforced wallpaper settings.
# Please restart or relogin into your device to apply the changes.
...
try {
    ...
    CreateLogDir
    Log "=== Reverting Wallpaper Personalization Restrictions ==="
