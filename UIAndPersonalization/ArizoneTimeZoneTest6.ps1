...
# This will gray out the UI; only LOCAL SERVICE can change timezone.
secedit.exe /export /cfg C:\temp\secpol.cfg
(gc C:\temp\secpol.cfg) -replace 'SeTimeZonePrivilege\s*=.*', 'SeTimeZonePrivilege = *S-1-5-19' | sc C:\temp\secpol.cfg
